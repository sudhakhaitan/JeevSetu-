JeevSetu Build 3.9 — Clinical Note formatter + optional BHASHINI V2-5-15 FRESH.

Based on V2-5-15 FRESH.

Working Hindi patient interaction, question sequence, and answer storage are unchanged.

Changes in V2-5-15:
- Keeps the V2-5-15 safe local clinical formatter and Duration cleanup.
...
V2-5-15: Clinical Note formatter rewritten. Hindi interaction flow and answer storage are unchanged. Duration is normalized to clean values such as '10 days'. The doctor-facing structured preview and Clinical Note Preview both use the same English formatter. BHASHINI remains available for unresolved Hindi phrases when a key is configured.
