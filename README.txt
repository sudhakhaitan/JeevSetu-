...
Build 3.9 Clinical Note Fix v2
- Patient interaction remains in Hindi.
- Doctor-facing Clinical Note Preview is English-only.
- Added phrase-level and word-level Hindi clinical translation.
- Untranslated Devanagari is never displayed in the Clinical Note Preview.
