...
- V2-5-2: Expanded the English clinical interpretation engine with sentence-level Hindi clinical phrases, common variants, vocabulary rules, and a strict no-Devanagari doctor-note barrier. Hindi patient interaction remains unchanged.
